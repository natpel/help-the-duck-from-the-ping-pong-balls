...
let Pong_ball: Sprite = null
scene.cameraFollowSprite(Pong_ball)
...
Pong_ball = sprites.create(img`
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Enemy)
Pong_ball.setBounceOnWall(true)
Pong_ball.vx = 40
Pong_ball.vy = 60
let ping_ball = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Enemy)
ping_ball.setBounceOnWall(true)
ping_ball.vx = 60
ping_ball.vy = 10
...
let mySprite2 = sprites.create(img`
    ...
    . . . . . f f . . f f . . . . . 
    `, SpriteKind.Player)
controller.moveSprite(mySprite2, 32, 58)
mySprite2.setPosition(143, 11)
